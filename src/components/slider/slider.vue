    ...
    >
      ...
      <template v-if="!sliderinit.loop">
        <template v-for="item in pages">
          <div class="slider-item" v-html="item.style">
            {{item.title}}
          </div>
        </template>
      </template>
      ...
      <template v-if="sliderinit.loop">
        <template v-if="sliderinit.infinite" v-for="(item, index) in pages" >
          <div v-if="index+sliderinit.infinite-pages.length>=0" class="slider-item" v-html=" item.style">{{item.title}}</div>
        </template>
        <template v-if="!sliderinit.infinite">
          <div class="slider-item" v-html="pages[pages.length-1].style">{{pages[pages.length-1].title}}</div>
        </template>
        <!-- 无缝滚动copy最后项 -->
        <template v-for="item in pages">
          <div class="slider-item" v-html="item.style">{{item.title}}</div>
        </template>
        <!-- 无缝滚动copy第一项 -->
        <template v-if="sliderinit.infinite" v-for="(item, index) in pages" >
          <div v-if="index-sliderinit.infinite<0" class="slider-item" v-html="item.style">{{item.title}}</div>
        </template>
        <template v-if="!sliderinit.infinite">
          <div class="slider-item" v-html="pages[0].style">{{pages[0].title}}</div>
        </template>
      </template>
    </div>
